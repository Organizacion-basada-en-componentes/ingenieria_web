...
\begin{longtable}{@{} p{1.5cm} p{5cm} p{3cm} p{2cm} p{3cm} @{}}
	...
	\addlinespace
	\stepcounter{requisitosFuncionales}RN\therequisitosFuncionales & Los pacientes pueden desbloquear logros (gamificación) al cumplir con sus ejercicios diarios. & Opcional & Ninguna & Charla con Paciente (chatGPT) \\
	\addlinespace
	\bottomrule
\end{longtable}
